...
from .lineutil import validate_function_args_return_value, LOGGER
from .lineexceptions import LinePayApiError
...
class LinePayApi(object):
    ...
    def round_amount_by_currency(cls, currency: str, amount: float):
        ...
        # If you use TWD. Need to round amount.
        if (CurrencyType.TWD.value == currency):
            amount = int(amount)
        return amount
